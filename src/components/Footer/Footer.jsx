      ...
      <div className="footer-container">
        <div className="footer-left">
          ...
          <div className="service-areas">
            <h3 className="service-title">Service Areas</h3>
        ...
        <div className="footer-center">
          ...
          <nav className="footer-nav-secondary">
            <a href="#terms" className="nav-link-secondary">Terms And Conditions</a>
            <a href="#privacy" className="nav-link-secondary">Privacy Policies</a>
          </nav>
        ...
        <div className="footer-right">
          <div className="contact-info">
            <h3 className="contact-title1">Get In Touch</h3>
            ...
            <div className="contact-item">
              ...
              <span className="contact-value">rapidstarwash@gmail.com</span>
            </div>
          </div>
        </div>
      </div>
